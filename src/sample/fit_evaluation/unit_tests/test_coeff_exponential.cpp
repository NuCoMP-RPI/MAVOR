...
TEST(ExponentialCoeffTest, Naive){
    EXPECT_NEAR(naive_exponential(x1, one_coeff), 1, abs_tol);
    EXPECT_NEAR(naive_exponential(x1, two_coeff), 2.359141, abs_tol);
    EXPECT_NEAR(naive_exponential(x1, three_coeff), 4.206405, abs_tol);
    EXPECT_NEAR(naive_exponential(x2, one_coeff), 1, abs_tol);
    EXPECT_NEAR(naive_exponential(x2, two_coeff), 1.218025, abs_tol);
    EXPECT_NEAR(naive_exponential(x2, three_coeff), 1.265559, abs_tol);
