...
/// @brief Evaluates sqrt log power functions at the given x up to order n and returns the results in a vector
/// @param x Value at which to evaluate the functions
/// @param n Max order to evaluate the functions
/// @return std::vector<double>(n+1) of the evaluated sqrt log power functions in ascending order
